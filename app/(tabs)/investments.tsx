...
export default function InvestmentsScreen() {
  ...
  const fetchData = async () => {
    const response = InvestmentServices.getPersonalInvestmentOverview(userId);
    setPersonalInvestments(await response);
    const getSips = SipServices.getAllSips(userId);
    setSipList(await getSips);
  };
  ...
  const currentHoldingDetails = (
    ...
    <TouchableOpacity
      ...
      onPress={() => {
        router.push({
          pathname: "/investments/holdingdetails",
  ...
  const sipDetails = (sip: Sip, index: number) => {
    ...
    return (
      <TouchableOpacity
        ...
        onPress={() => {
          router.push({
            pathname: "/investments/sipdetail",
